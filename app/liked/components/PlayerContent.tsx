    ...
    <div className="grid grid-cols-2 md:grid-cols-3 h-full">
      ...
      <div className="hidden h-full md:flex justify-center items-center w-full max-w-[722px] gap-x-6">
        ...
        <div
          onClick={handlePlay}
          className="
        flex items-center justify-center h-10 w-10 cursor-pointer p-1 bg-white rounded-full
        "
        >
          <Icon size={30} className="text-black" />
        </div>
        <AiFillStepForward
          onClick={onPlayNext}
          size={30}
          className="cursor-pointer hover:text-white text-neutral-400 transition"
        />
      </div>
